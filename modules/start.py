...
def StartMachinePCT(number_of_machine, user_id):
        ...
        send_command    = [["/usr/sbin/pct", "unlock", str(number_of_machine)], ["/usr/sbin/pct", "clone", str(number_of_machine), str(user_machine), "--pool", "Users_Pentest"], ["/usr/sbin/pct", "set", str(user_machine), "-net0", network_setting], ["/usr/sbin/pct", "start", str(user_machine)]]
